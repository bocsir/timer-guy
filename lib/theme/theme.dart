...
extension TextExtension on FTypography {
  ...
  TextStyle get xlSemibold => _withMonoFont(xl, fontWeight: FontWeight.bold);
  TextStyle get xl3Semibold => _withMonoFont(xl3, fontWeight: FontWeight.bold);
...
FThemeData get zincDark {
  ...
  final customTextFieldStyles = textFieldStyle(colors: colors, typography: typography, style: style);
